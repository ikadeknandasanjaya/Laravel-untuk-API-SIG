    ...
    <AppLayout>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex justify-between items-start mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Marker Categories</h1>
                    <p class="mt-1 text-sm text-gray-500">Kelola marker categories</p>
                </div>
...
export default {
    ...
    data() {
        return {
            ...
            categoryService: new CategoryService('marker'),
        };
    },
    mounted() {
        this.loadCategories();
    ...
    methods: {
        ...
        async saveCategory() {
            try {
                if (!this.form.name.trim()) {
                    toast.error('Nama harus diisi', 'Kesalahan Validasi');
                    return;
                }
                ...
                if (this.editingId) {
                    ...
                    toast.success('Kategori berhasil diperbarui!', 'Sukses');
                } else {
                    // Create new
                    await this.categoryService.create(this.form);
                    toast.success('Kategori berhasil dibuat!', 'Sukses');
                }
                ...
                toast.error('Gagal menyimpan kategori', 'Kesalahan');
            }
        },
        async deleteCategory(id) {
            ...
            try {
                ...
                toast.success('Kategori berhasil dihapus!', 'Sukses');
                // Reload categories after delete
                await this.loadCategories();
            } catch (error) {
                console.error('Error deleting category:', error);
                toast.error('Gagal menghapus kategori', 'Kesalahan');
            }
        },
    },
};
