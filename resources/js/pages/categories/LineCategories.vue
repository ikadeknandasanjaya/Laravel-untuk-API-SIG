    ...
    <AppLayout>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex justify-between items-start mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Line Categories</h1>
                    <p class="mt-1 text-sm text-gray-500">Kelola line categories</p>
                </div>
...
export default {
    ...
    data() {
        return {
            ...
            categoryService: new CategoryService('line'),
        };
    },
    mounted() {
        this.loadCategories();
